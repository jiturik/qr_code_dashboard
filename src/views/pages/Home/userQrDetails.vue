<template>
  <div>
    <b-row>
      <b-col cols="12" md="8">
        <div class="mb-1">
          <button class="AddNewButton text-center mr-1" @click="
            $router.push({
              name: 'createqr',
          ...
          <button class="AddNewButton text-center" @click="
            $router.push({
              name: 'scanDetails',
              query: { qrId: unique_code_generate },
            })
          ...
          <div>
            <div class="panel panel-info">
              <div class="panel-heading m-2">
                <div>
                  <b-col>
                    <b-row v-for="(imgItem, imgIndex) in userDetailsArray" :key="imgIndex"
                      v-if="imgItem.key == 'photo'">
                      <b-col>
                        <b-img v-if="imgItem.vModelValue" class="align-left text-left mt-2" width="150" height="150"
                          fluid :src="BASE_URL + imgItem.vModelValue" alt="Image"></b-img>
                        <b-img width="150" height="150" v-else class="m-1" fluid :src="imgAvtar" alt="Image 1"></b-img>
                      </b-col>
                      <b-col>
              ...
              <div>
                <div>
                  <div>
                    <table class="table">
                      <tbody>
                        <tr v-for="(item, index) in userDetailsArray" :key="index">
                          <td align="left" style="text-align: left" v-if="!['photo', 'document'].includes(item.key)">
                            <b> {{ item.label }} </b><br />
                            <div style="text-align: left; width: 50%" v-if="item.inputType == 'quill'"
                              v-html="item.vModelValue"></div>
